    ...
    <div className="md:hidden flex flex-col my-8">
      <div className="flex gap-10">
        ...
        <div>
          ...
          <h1 className="font-body py-2">0 Members</h1>
          <h1 className="font-body py-2">0 Projects</h1>
          <h1 className="font-body py-2">Chama ID</h1>
        </div>
      </div>
      <div className="my-4">
...
function Chamas() {
  return (
    <div className="px-2 md:px-10">
      ...
      <div className="mx-4 mb-4 rounded-md p-2 shadow-xl flex items-center justify-between bg-gradient-to-r from-primary to-black">
        <div className="md:mx-8 mx:2">
          <h1 className="lg:text-5xl md:text-3xl text-xl font-bold font-heading">
            Let's Build Communities
          </h1>
          <button className="bg-black text-white text-sm md:text-lg rounded-md font-heading font-semibold md:px-4 px-2 py-2 md:mt-8 mt-4 hover:bg-transparent hover:text-black transition-all ease-in duration-150 border-black border-[2px]">
            Dashboard
          </button>
        </div>
        <img
      ...
      <div className="flex flex-col md:flex-row justify-between">
        ...
        <div className="hidden md:flex flex-col my-8 w-[40%]">
          ...
          <div className="my-4">
            ...
            <p className="font-body p-2 leading-relaxed text-sm">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam, at
              aliquid. Explicabo quidem qui, aperiam illum eum itaque culpa
              quisquam cum esse voluptatibus aliquid neque impedit harum
              reiciendis similique quas. Molestias inventore quaerat esse nulla
              iusto vitae omnis magni iste possimus?
            </p>
          </div>
        </div>
      </div>
