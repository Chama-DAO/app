...
import CreateChama from "./create-chama";
        ...
        <div className="flex flex-col items-center justify-center mx-2">
          <dialog id="my_modal_3" className="modal">
            <div className="modal-box">
              ...
              {currentChama?.id && <CreateProject id={currentChama?.id} />}
            </div>
          </dialog>
        </div>
      </div>
            ...
            <div key={index} className="w-full">
              <div className="flex-col flex gap-2 px-1 shadow-sm rounded-md md:mx-2 md:px-4 py-8 w-full cursor-pointer hover:scale-95 ease-in-out transition-all duration-150">
                ...
                <div className="flex justify-between">
                  <div>
                    <h1 className="font-bold font-heading">{project.title}</h1>
                  ...
                  <div>
                    <div className="flex items-center justify-between gap-4">
                      <p className="font-heading">{project.progress}% done</p>
