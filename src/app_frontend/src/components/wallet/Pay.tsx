  ...
  return (
    <div className="mt-4">
      ...
      <div className="flex gap-4 mt-4 justify-between flex-col md:flex-row">
        <div className="flex justify-center items-center rounded-md bg-secondaryAccent w-1/2 cursor-pointer">
          <img src={mpesaLogo} alt="Mpesa Logo" className="h-20 w-30" />
        </div>
        <div className="flex justify-center items-center rounded-md bg-gray-300 w-1/2 cursor-not-allowed">
